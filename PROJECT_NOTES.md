...
Owns incoming room snapshot application:

- Normalizes remote game-state payloads
- Normalizes room metadata, members, join requests, and player payloads
- Applies the next local state through a mutation callback
