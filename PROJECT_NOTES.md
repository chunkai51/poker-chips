...
Owns the identity and local-view toolbar UI:

- Top bar local/room mode button state
- Room entry button enablement
- Device identity summary and pending request badge
