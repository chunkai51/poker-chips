const GUIDE_TABS = [
  {
    ...
    label: "使用指南",
    cards: [
      ["01", "进入房间", "同桌设备输入同一个房间 ID 后同步。不填房间号会自动生成。"],
      ["02", "创建房间", "设置初始筹码和大盲注，再添加玩家，2-10 名玩家才能开始游戏。点击开始游戏完成房间创建。"],
  ...
  },
  {
    id: "rules",
    label: "德扑规则",
    flow: ["每人发两张底牌", "翻牌前下注", "翻牌三张", "转牌一张", "河牌一张", "摊牌比牌"],
    cards: [
      ...
      ["All In", "All In 是把剩余筹码全部投入。若其他玩家筹码更多，则 All in 的玩家只参与对等的筹码争夺，余出部分形成边池。"],
      ["摊牌", "河牌下注结束后，未弃牌的玩家亮牌。牌型最大者赢得对应奖池，多名玩家牌型完全相同则平分奖池。"]
    ]
  },
  {
    id: "hands",
